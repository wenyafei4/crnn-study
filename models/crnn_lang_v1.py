...
class CRNN(nn.Module):
    ...
    def __init__(self, imgH, nc, nclass, nh, n_rnn=2, leakyRelu=False):
        ...
        self.rnnCTC = BidirectionalLSTM(nh, nh, nclass)
        self.rnnAttention = BidirectionalLSTM(nh, nh, nh)
    ...
    def forward(self, input, length, text):
        ...
        # rnn features
        rnn = self.rnn(conv)
        outputCTC = self.rnnCTC(rnn)
        outputAttention = self.attention(self.rnnAttention(rnn), length, text)
